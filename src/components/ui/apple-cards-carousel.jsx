  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div className="mr-10 lg:-mt-20 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full border border-white disabled:opacity-30"
            onClick={scrollLeft}
